<template>
  ...
  <div class="container">
      ...
      <div class="course-detail__info info">
        ...
        <div class="info__item-block block">
          <div class="block__users">
            <p class="block__title">Кто должен проходить проверку знаний:</p>
    ...
    <div v-else class="not-found">
      ...
      <button type="button" class="info__back-btn" @click="$router.push('/training_programs/energy_security/')">
        К списку программ
      </button>
    </div>
  </div>
