    ...
    <div class="container">
      ...
      <div v-if="course" class="course-detail__info info">
          <div class="info__item-top top">
            <h1 v-if="course" class="top__title">{{ course.title }}</h1>
            <h1 v-else class="top__title">Курс не найден</h1>
          ...
          <div class="info__item-block block">
            <div class="block__users">
                ...
                <ul class="block__users-list">
                    <li v-for="(user, index) in course.users" :key="index" class="block__users-item">
                        <img :src="checkIkon" class="block__img"/>
                        <span>{{ user }}</span>
                    </li>
                </ul>
            </div>
            ...
            <div class="block__require" v-if="course.requiremets">
            ...
            <div class="block__row row">
                ...
                <div class="row-item" v-if="course.format">
