...
export const courseList =[
  ...
  },
  {
    ...
    text: 'Подготовка руководителей организации и специалистов в области охраны окружающей среды  и экологиечской безопасности, отетственных за принятие решений  при осуществениии хозяйственной и иной деятельности, которая оказывает или может оказать  негативное воздействие  на окружающую среду, осуществляеся в соотвествии с законодательсвом',
    image: mainEco,
  ...
  },
  {
    ...
    text: 'Профессиональное обучение направлено на приобретение лицами разлиного возраста профессиональной компетенции, в том числе для раоты с конкретным оборудованием, технологиями, аппартано-программными и иными профессиональными средствами, получение указанныи лицами квалификации по профессии рабочего ',
    image: mainProf,
