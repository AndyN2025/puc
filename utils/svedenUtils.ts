...
export const courseList =[
  ...
  },
  {
    ...
    text: 'Подготовка руководителей организации и специалистов в области охраны окружающей среды и экологической безопасности, ответственных за принятие решений при осуществлении хозяйственной и иной деятельности, которая оказывает или может оказать негативное воздействие на окружающую среду, осуществляется в соответствии с законодательством',
    image: mainEco,
  ...
  },
  {
    ...
    text: 'Подготовка к проверке знаний по ПТЭ ТО И ТПУ. Правила технической эксплуатации объектов теплоснабжения и теплопотребляющих установок.',
    image: mainEnergy,
  ...
  },
  {
    ...
    text: 'Профессиональное обучение направлено на приобретение лицами различного возраста профессиональной компетенции, в том числе для работы с конкретным оборудованием, технологиями, аппаратно-программными и иными профессиональными средствами, получение указанными лицами квалификации по профессии рабочего',
    image: mainProf,
  ...
  },
  {
    ...
    text: 'Обучение рабочего персонала опасных производственных объектов (ОПО) в области промышленной безопасности',
    image: mainOPO,
